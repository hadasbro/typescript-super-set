...
import { SortedHashSet } from './sortedHashSet'
import { HashableObservable } from '../types/types'

/**
 * SortedHashSetObs<T extends Observable>
 *
 * Hash Set with order.
 *
 ...
 * @see HashSet<T>
 */
export class SortedHashSetObs<T extends HashableObservable<S>, S extends number | string>
  extends SortedHashSet<T, S>
  implements SortedSetInterface<T>, Observer {
  /**
   * update
   *
   * @param element
